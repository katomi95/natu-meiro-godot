	...
	return [
		{
			...
			"sun_dir": Vector3(0.12, 0.88, 0.46), "sun_energy": 2.8, "sun_color": Color(1, 0.96, 0.86),
			"sky": {"zenith": Color(0.03, 0.17, 0.6), "mid": Color(0.13, 0.43, 0.92), "horizon": Color(0.6, 0.8, 1.0), "energy": 0.95, "overcast": 0.0, "cirrus": 0.0},
			"clouds": "cumulus", "fog": 0.0022, "fog_color": Color(0.74, 0.85, 1.0), "vol_fog": 0.008,
			"ambient": 1.05, "exposure": 1.08, "saturation": 1.15, "contrast": 1.1,
			"glow": [0.85, 0.14, 0.85], "flare": 1.0,
		...
		},
		{
			...
			"sun_dir": Vector3(0.62, 0.58, -0.28), "sun_energy": 2.6, "sun_color": Color(1, 0.93, 0.78),
			"glow": [0.85, 0.14, 0.85], "flare": 1.0,
			...
			"ambient": 1.0, "exposure": 1.08, "saturation": 1.1, "contrast": 1.08,
